...
public class DialogWithClient {
    ...
    public BotApiMethod<?> dialog(Message message, DialogueContext context, CRUDChannelServiceImpl crudChannelService) {
        ...
        BotApiMethod<?> execute = dialogueState.execute(channel, sendMessage);
