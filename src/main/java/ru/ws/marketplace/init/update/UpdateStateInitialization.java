...
public class UpdateStateInitialization {
    ...
    private BotApiMethod<?> channelPostProcess(BotApiObject botApiObject) {
        ...
        final String token = "5277995877:AAFxEZE5tVi1XTcxIGKIV6N7M-2hKuXfhjE";
        ...
        Integer requestOnTelegramAPI = checkerUsers.createRequestOnTelegramAPI(token, id.toString(), firstName);
